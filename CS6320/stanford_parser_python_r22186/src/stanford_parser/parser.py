...
class Dependencies:
    ...
    def relForConstituents(self, gov, dep):
        # a dict is not callable so use [] instead of ()
...
def startJvm():
    import os
    os.environ.setdefault("STANFORD_PARSER_HOME", "/Users/jiadao/PycharmProjects/untitled/NLP/Proj_MovieReview/stanford_parser_python_r22186/3rdParty/stanford-parser")
...
class Parser:
    ...
    def parse(self, sentence):
        ...
        #if not None,False,empty string"" or 0.then executre following step
        if not wasParsed:
