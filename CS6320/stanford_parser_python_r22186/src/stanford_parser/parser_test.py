...
# sys.path.append("/Users/jiadao/PycharmProjects/untitled/NLP/Proj_MovieReview/stanford_parser_python_r22186/src/stanford_parser")

class TestCase(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        from NLP.Proj_MovieReview.stanford_parser_python_r22186.src.stanford_parser.parser import Parser
        # import NLP.Proj_MovieReview.stanford_parser_python_r22186.src.stanford_parser.parser
        cls.parser = Parser()
